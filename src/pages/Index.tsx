        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {apps.map((app) => (
            <button
              ...
              className="group relative flex flex-col items-center gap-3 rounded-2xl border-2 border-border bg-card p-6 text-card-foreground transition-all duration-200 hover:border-primary/40 hover:shadow-lg hover:-translate-y-1 active:translate-y-0 active:shadow-none"
            >
              <div className={`flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br ${app.color} shadow-lg`}>
